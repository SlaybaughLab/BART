#ifndef BART_SRC_EIGENVALUE_K_EFFECTIVE_K_EFFECTIVE_UPDATER_I_HPP_
#define BART_SRC_EIGENVALUE_K_EFFECTIVE_K_EFFECTIVE_UPDATER_I_HPP_
...
#endif // BART_SRC_EIGENVALUE_K_EFFECTIVE_K_EFFECTIVE_UPDATER_I_HPP_