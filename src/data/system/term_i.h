...
/*! \brief Stores and provides vectors/matrices for linear/bilinear terms.
 *
 * Vector/matrices are stored differently if they are fixed (will not change iteration
 ...
 * when needed.
 *
 * Each group and angle requires its own, so storage based on
