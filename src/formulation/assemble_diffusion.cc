...
//template<int dim>
//void AssembleDiffusion<dim>::AssembleFixedBilinearTerms(GroupNumber group) {
...
//
//template<int dim>
//void AssembleDiffusion<dim>::AssembleFixedLinearTerms(GroupNumber group) {
...
//
//template<int dim>
//void AssembleDiffusion<dim>::AssembleVariableLinearTerms(
//    GroupNumber group,
