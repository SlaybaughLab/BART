#ifndef BART_SRC_INSTRUMENTATION_FACTORY_COMPONENT_FACTORIES_H_
#define BART_SRC_INSTRUMENTATION_FACTORY_COMPONENT_FACTORIES_H_
...
#endif //BART_SRC_INSTRUMENTATION_FACTORY_COMPONENT_FACTORIES_H_
