...
class IterationBase {
 ...
 protected:
  ...
  const unsigned int n_group_;//!< Number of groups.
  ...
  unsigned int ct_ho_iters_; /**< HO iteration counts*/
  unsigned int ct_nda_iters_; /**< NDA iteration counts*/

  std::string ho_equ_name_;//!< High-order equation name
  std::string iter_equ_name_;//!< Name of equation used in iterations

  dealii::Vector<double> moment_prev_;
};
